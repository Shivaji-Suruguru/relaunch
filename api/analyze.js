export default async function handler(req, res) {
  ...
  // TODO: Verify JWT (we assume valid for now if passed, or we can check header)
...
\`;
  ...
  try {
    ...
    // Fallback if result is missing key properties
    ...
    console.error(err);
    res.status(200).json({ // Return fallback
        readinessScore: 78,
