...
import { 
  ...
  Sparkles, Check, Search, Download, Star, MapPin
} from 'lucide-react';
  ...
  <style>{`
    ...
    * {
    ...
    input:focus, textarea:focus, select:focus {
      ...
      box-shadow: 0 0 0 3px rgba(124, 61, 110, 0.1);
    }
    ...
    .btn-plum:hover {
      ...
      box-shadow: 0 4px 12px rgba(124, 61, 110, 0.2);
    }
    ...
    .card:hover {
      ...
      box-shadow: 0 12px 24px rgba(45, 31, 42, 0.05);
    }
    ...
    @keyframes pulse-ring {
      0% { transform: scale(0.8); box-shadow: 0 0 0 0 rgba(124, 61, 110, 0.5); }
      70% { transform: scale(1); box-shadow: 0 0 0 20px rgba(124, 61, 110, 0); }
      100% { transform: scale(0.8); box-shadow: 0 0 0 0 rgba(124, 61, 110, 0); }
    }
    ...
    .text-gradient {
      background: linear-gradient(to right, #D4A853, #A0517F);
    ...
    .nav-glass {
      background: rgba(253, 250, 248, 0.8) !important;
      backdrop-filter: blur(12px);
